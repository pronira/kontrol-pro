        ...
        l.diag_steps.forEach(function(step) {
          ...
          if (sName === 'rss_fetch') {
            ...
            extraHtml = 'знайдено: <b>' + step.raw_count + '</b>'
              + (step.sample_titles && step.sample_titles.length ? ' | ' + step.sample_titles.map(function(t){ return '"' + gfE(t) + '"'; }).join(', ') : '');
            ...
            extraHtml = '<span style="color:#fca5a5">' + gfE((step.error||'').slice(0,200)) + '</span>'
